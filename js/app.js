// (function($) {
    ...
    // When game ends
    var gameOver = function(setWinnerClass, winnerName) {
        // Hide #board div
        $("#board").hide();
        ...
        $("body").html(finishDivContent);

        // Indicate winner
        $("#finish").addClass(setWinnerClass);
        if (setWinnerClass === "screen-win-tie") {
            $(".message").html("It's a Tie!");
        } else {
            $(".message").html(winnerName);
        }
